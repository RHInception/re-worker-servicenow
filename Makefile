...
# Makefile for re-worker-servicenow
#
...
RPMSPEC := $(RPMSPECDIR)/re-worker-servicenow.spec
...
srpm: rpmcommon
	...
	@find rpm-build -maxdepth 2 -name 're-worker-servicenow*src.rpm' | awk '{print "    " $$1}'
	@echo "#############################################"
...
rpm: rpmcommon
	...
	@find rpm-build -maxdepth 2 -name 're-worker-servicenow*.rpm' | awk '{print "    " $$1}'
	@echo "#############################################"
